...
cameraFeed= False #For live camera feed
videoPath = 'resources/test1.mp4'
cameraNo= 1
frameWidth= 500
frameHeight = 350

if cameraFeed:intialTracbarVals = [24,55,12,100]  #[Top points width,Top point height,Bottom points width,Bottom points height]
else:intialTracbarVals = [32,63,3,97]   #[Top points width,Top point height,Bottom points width,Bottom points height]
...
while True:
    ...
    try:
        ...
        cv2.putText(imgFinal, str(int(averageCurve)), (frameWidth//2-70, 70), cv2.FONT_HERSHEY_DUPLEX, 1.75, (255, 255, 255), 2, cv2.LINE_AA)
    ...
    cv2.imshow("All Steps",imgStacked)
